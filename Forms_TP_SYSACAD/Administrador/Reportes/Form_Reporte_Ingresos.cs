...
namespace Forms_TP_SYSACAD
{
    public partial class Form_Reporte_Ingresos : Form
    {
        ...
        public Form_Reporte_Ingresos(List<RegistroDePago> listaRegistrosAMostrar, DateTime fechaDesde, DateTime fechaHasta)
        {
            ...
            _pagosTotales = EstadisticasReportes.CalcularRegistrosTotales(listaRegistrosAMostrar);
            _ingresosTotales = EstadisticasReportes.CalcularMontoIngresosTotales(listaRegistrosAMostrar);
