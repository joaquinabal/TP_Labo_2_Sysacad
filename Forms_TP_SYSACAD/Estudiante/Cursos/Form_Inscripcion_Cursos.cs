...
namespace Forms_TP_SYSACAD
{
    public partial class Form_Inscripcion_Cursos : Form
    {
        ...
        /// <summary>
        /// Actualiza el ListView que muestra los cursos disponibles para que un estudiante se inscriba.
        /// </summary>
        private void MostrarListView()
        {
            ...
            if (_listaCursosDisponibles.Count > 0)
            {
                ...
                {
                    cursosPertenecientesAlEstudiante = ConsultasCursos.ObtenerListaCursosDesdeListaCodigos(Sistema.EstudianteLogueado.CursosInscriptos);
                }
        ...
        private void listViewCursosEst_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            ...
            foreach (ListViewItem item in listViewCursosEst.SelectedItems)
            {
                ...
                Curso curso = ConsultasCursos.ObtenerCursoDesdeCodigo(codigo);
        ...
        /// <summary>
        /// Maneja el evento de hacer clic en el botón de inscripción a cursos.
        /// </summary>
        private void btnInscribirse_Click(object sender, EventArgs e)
        {
            ...
            ValidacionInscripcionResultado resultadoValidacion = nuevaValidacion.ValidarCursosSegunCupo(_cursosSeleccionados);
