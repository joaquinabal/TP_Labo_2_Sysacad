    ...
    public static class GeneradorDePDF
    {
            ...
            string fechaEmision, string fechaDesde, string fechaHasta)
        {
            try
            {
                ...
                Paragraph title = section.AddParagraph($"Reporte de Inscripciones {titulo}  \nPeriodo: {fechaDesde} a {fechaHasta}");
                ...
                // Agregar un párrafo para la fecha de emision
                Paragraph helloParagraph = section.AddParagraph($"Fecha de Emision: {fechaEmision}");
                helloParagraph.Format.Alignment = ParagraphAlignment.Left;
                helloParagraph.Format.Font.Size = 14;
                helloParagraph.Format.SpaceAfter = "0.5cm"; // Agrega espacio después del párrafo
            ...
            {
                Console.WriteLine("Error al enviar el generar el PDF: " + ex.Message);
                return false;
            }
        }
