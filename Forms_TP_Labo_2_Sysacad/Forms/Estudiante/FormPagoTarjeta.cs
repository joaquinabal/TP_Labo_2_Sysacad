...
namespace Forms_TP_Labo_2_Sysacad
{
    public partial class FormPagoTarjeta : FormPadre
    {
        ...
        private async void pagarBtn_Click(object sender, EventArgs e)
        {
            ...
            ValidadorInputGenerico validadorDeTarjeta = new ValidadorInputGenerico();

            RespuestaValidacionInput resultadoValidacion = validadorDeTarjeta.ValidarDatos(dirCampos, ModoValidacionInput.MediosPagoTarjeta);
