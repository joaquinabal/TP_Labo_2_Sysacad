    ...
    public partial class FormPagoTransferencia : FormPadre
    {
       ...
       private List<RegistroDePago> GenerarListaRegistroDePagos()
        ...
        private async void pagarBtn_Click(object sender, EventArgs e)
        {
            ...
            RespuestaValidacionInput resultadoValidacion = await gestorPagos.GestionarPago(dirCampos, _conceptosSeleccionados, DateTime.Now, ModoValidacionInput.MediosPagoTransferencia);
