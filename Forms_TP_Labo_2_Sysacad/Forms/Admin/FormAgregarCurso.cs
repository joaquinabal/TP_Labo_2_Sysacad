...
namespace Forms_TP_Labo_2_Sysacad
{
    public partial class FormAgregarCurso : FormPadre
    {
        ...
        private void agregarBtn_Click(object sender, EventArgs e)
        {
            ...
            bool resultadoValidacion = ValidadorDuplicados.ValidarDuplicados(codigo: _codigo);
            ...
            else
            {
                ...
                {
                    Curso nuevoCurso = new Curso(_nombre, _codigo, _descripcion, int.Parse(_cupo), _turno, _aula, _dia);
