...
namespace Forms_TP_Labo_2_Sysacad
{
    public partial class FormRegEst : FormPadre
    {
        ...
        private async void registrarBtn_Click(object sender, EventArgs e)
        {
            ...
            bool resultadoValidacion = ValidadorDuplicados.ValidarDuplicadosEstudiantes(legajo: _legajo, correo: _correo);

            RespuestaValidacionInput validacionEstudiante = validadorInputEstudiantes.ValidarDatos(dictCampos, ModoValidacionInput.Estudiantes);
            ...
            else
            {
                if (!resultadoValidacion)
                {
                    ...
                    await nuevoEstudiante.Registrar();
